...
(async function main() {
  ...
  const videobps2 = document.getElementById('js-bitrate2-text');
  ...
  joinTrigger.addEventListener('click', () => {
    ...
    function onClickSend() {
        ...
        switch(monitor_mode) {
          case 1:
            vrMonitor.setAttribute('position', "0 0 -130");
  ...
  join2Trigger.addEventListener('click', () => {
    ...
    const bps2 = parseInt(videobps2.value)
